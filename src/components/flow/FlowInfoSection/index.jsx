...
export const FlowInfoSection = ({ descriptionArray = [], id, imageSrc, subtitle, title, transition = true, theme = "dark", videoSrc }) => {
  ...
  const TextContent = () => {
    return (
      <>
        ...
        {subtitle && <p className={cx(styles.contentSubtitle, styles[theme])}>{subtitle}</p>}
      ...
      <div id={id} className={cx(styles.container, styles[theme])}>
        {isLightTheme ? (
          <div className={styles.content}>
            ...
            <div className={cx(styles.rightContent, { [styles.isVideo]: Boolean(videoSrc) })}>
              <VideoImageContent />
            </div>
          </div>
        ) : (
          <div className={styles.content}>
            <div className={cx(styles.leftContent, { [styles.isVideo]: Boolean(videoSrc) })}>
              <VideoImageContent />
            </div>
