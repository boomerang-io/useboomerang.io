  ...
  return (
    <Layout>
      ...
      <Skills
        ...
        paragraph={
          <>
            Open-source and cloud-native orchestration tool for workflow
            automation.
            <div style={{ paddingBottom: '1rem' }} />A new scalable and
            extensible modern approach to automation focused on the end user
            experience with lower cost and increased productivity.
          </>
        }
        imgAlt="Flow"
      ...
      <Skills
        ...
        paragraph={
          <>
            Policy-based gating system that combines Policy Definitions with
            Rules and Metrics Data to validate if specific Gates are passed.
