...
| Task Name                      | Description                                                                                                                                                                                | Result Parameters                                                    |
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------- |
| **Execute Advanced HTTP Call**          | Makes an HTTP request specifying an endpoint and retrial capabilities.                                                                                                                                          | <ul><li>`response` with the content of the HTTP request</li><li>`statusCode` HTTP response code</li></ul>                      |
