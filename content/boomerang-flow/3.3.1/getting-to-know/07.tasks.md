...
The Team Task Manager can be found under Manage > Team Tasks and allows users in the team to create and manage tasks scoped to the team and only available to that team. For more information, see [How to Manage Team Tasks](/useboomerang.io/docs/how-to-manage/team-tasks).
...
The YAML specification has three important sections to be aware of: metadata, params, and steps. Its important to note that the full Tekton task specification is not yet fully supported. We cannot run multi-step tasks, nor do we allow resources to be specified. For more information, see [Known Issues and Limitations](/useboomerang.io/docs/introduction/known-issues).
...
| **Run Custom Task**            | A special type of System task. With the Custom task, you can bring your own container and run that as a task. Custom tasks also have a specialized ability to dynamically create result parameters, see [Getting To Know Parameters](/useboomerang.io/getting-to-know/parameters).                                                                                                                                                                                                                                                                                               |                                                                                                                                                                                                                                                                                                     |
...
| **Wait For Event**             | Wait for an event from an external system to resume workflow execution. The event can be a webhook or a Cloud Event. Visit the [eventing architecture]((/useboomerang.io/docs/architecture/eventing)>) for more information.                                                                                                                                                                                                                                                                                                                                                         |

## Template Tasks

The following tasks are available as verified tasks. Their result parameters that are available for use are identified, refer to [Getting To Know Parameters](/useboomerang.io/docs/getting-to-know/parameters) for more information on how to use result parameters or provide input to tasks with parameters.
